...
def test_parse_urls_with_date():
    test_urls = (
        ...
        ('2012-02-29 00:00:00', 'http://www.news.com/Feb/29/2012/beyonce-album_n_4453500.html'),
...
#guess = guess_date(url='https://expresso.pt/economia/2021-04-24-Quem-ganhou-e-perdeu-nas-negociacoes-da-bazuca--84c43f2b ',html='')
#print(guess.date)